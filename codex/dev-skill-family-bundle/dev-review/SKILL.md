---
name: dev-review
description: review an implemented change against the approved specification and approved implementation plan. use when coding and tests are already in place and codex should verify that the result matches the requested behavior, satisfies acceptance criteria, respects the plan, and identify any remaining gaps. trigger this skill for final self-review before handing work back to the user and for deciding whether another implementation-test-verify loop is needed.
---
